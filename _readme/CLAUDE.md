...
- **`/contact/`** (`contact.md`) — the general-purpose form (name, email, subject, question) for presales questions and anything that doesn't fit the two specialized forms below. Above the form it links out to those two.
- **`/troubleshooting-support/`** (`troubleshooting-support.md`) — the troubleshooting-request form (kit/product, order #, issue description, test setup, what's been tried, photos). Was originally built at `/contact/` and moved here once the general contact form was added.
