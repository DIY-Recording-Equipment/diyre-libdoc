...
Most SB2 problems trace back to one of the yellow resistor arrays soldered in backward, or a cold solder joint on the DB25 connector. A quiet output after summing is also often just how a passive summing mixer behaves, not a fault.
...
1. Check the orientation of the yellow resistor arrays against the manual. The pin 1 dot should line up with the PCB's square pad. A reversed array here is the single most common cause of a channel imbalance.
...
4. If you have a multi-meter you can check your build by confirming the resistance between the points in this chart: [SB2 Resistance Testing Values (Google Sheets)](https://docs.google.com/spreadsheets/d/1BeqA4_xBLnzx1VZ9KrdT6MJ01Qyhc9CvU8hx19foHd4/edit?usp=sharing).
