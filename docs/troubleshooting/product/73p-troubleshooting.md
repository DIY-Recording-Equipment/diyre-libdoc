...
## No signal, or signal cuts out at a specific gain setting {.step}
...
## Output is a specific amount quieter than expected at every gain setting {.step}
...
## A few things that seems like problems but aren't {.step}
