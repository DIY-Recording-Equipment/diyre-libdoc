...
## 1. "Glue" sounds more intense than "Mojo," or the GLUE/MOJO switch seems backward
...
## 2. A resistor value doesn't match your documentation
...
## 3. Diodes look different from what the parts sheet or photos show
...
## 4. Little or no audible saturation
...
## 5. Saturation sounds far more extreme than expected for mix-bus use
...
## 6. Dead or noisy unit after assembly
