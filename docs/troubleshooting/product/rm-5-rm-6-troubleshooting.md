...
## Very quiet signal, hiss, or needing extreme preamp gain {.step}
...
## Transformer or motor was difficult to fit into the body, and a lead snapped or pulled loose {.step}
...
## Ribbon broke during assembly or use {.step}
...
## Wiring doesn't match the manual (RM-5) {.step}
...
## End cap won't seat, or seems misaligned {.step}
...
## Cosmetic damage on arrival, or an end cap frozen shut {.step}
