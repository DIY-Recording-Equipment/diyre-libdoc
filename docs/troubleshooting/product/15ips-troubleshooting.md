...
## A resistor or diode doesn't match your sorting sheet {.step}
...
## Wrong-looking op-amp IC, or a diode that doesn't match what's pictured {.step}
...
## Two 15IPS modules sound or measure different from each other {.step}
...
## Diode cracked while installing it, or looks visibly deformed {.step}
...
## Distortion, intermittent signal, no audio, or level drift over time {.step}
