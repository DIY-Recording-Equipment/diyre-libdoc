...
## 1. Transformer fails a resistance or continuity test
...
## 2. Weak, thin, or low-level output
...
## 4. Volume knob pops off, or the volume pot doesn't fully attenuate
