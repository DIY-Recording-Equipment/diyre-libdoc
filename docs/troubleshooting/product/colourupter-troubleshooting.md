...
## Output jumps up (or down) as soon as the Colourupter engages, even with Colour at zero {.step}
...
## Distortion, sudden volume drops, or LED behavior that changes after the unit worked fine initially {.step}
