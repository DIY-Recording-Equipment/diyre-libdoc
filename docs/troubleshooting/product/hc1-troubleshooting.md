...
## No sound, or the sound cuts out after a few seconds {.step}
...
## Buzzing or humming that gets worse as you turn up the volume {.step}
...
## Too loud, or the volume jumps too much per click {.step}
...
## Weak, distorted, or dead sound only at the first few clicks of the volume knob {.step}
...
## The same channel's op-amp keeps blowing {.step}
...
## Connecting a balanced or XLR source to the HC1 {.step}
