...
## 1. No signal, or silent even though the LED lights up
...
## 2. Intermittent silence, low output, hiss, or a "womf" oscillation sound
...
## 3. Hiss or noise beyond the TM79's normal baseline
...
## 4. TM79 sounds too subtle, or gain seems to drop unexpectedly
...
## 5. Standoffs don't align with the CP5's mounting holes
