...
## Very low output, or hiss increasing as you turn the gain up {.step}
...
## +48v phantom power doesn't work {.step}
...
## Distortion, oscillation, or a descending beep tone when phantom power is engaged {.step}
...
## Loud feedback or squeal at maximum gain with no mic connected {.step}
