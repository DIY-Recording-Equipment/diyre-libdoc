...
## No signal, or a dead build {.step}
...
## LED is dim, stuck on one color, or won't light {.step}
...
## Low output, attenuated signal, or one channel quieter than the other {.step}
...
## Pot spins freely, feels gritty, or causes intermittent sound {.step}
...
## Latch button won't retain, or fails to hold a module in place {.step}

The button's retention pin has failed. This needs a replacement latch rather than a repair.

## A power rail reads wrong, or a fuse trips {.step}
