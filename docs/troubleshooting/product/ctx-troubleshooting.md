...
## No sound, or sound drops out when Colour is engaged {.step}
...
## Distorted, too loud, or one channel doesn't match the other {.step}
...
## It worked for a while, then stopped {.step}
