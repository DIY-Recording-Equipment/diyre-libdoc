...
## 1. The 1N34A diode (D2/D4) looks bigger or different from the assembly guide photos
...
## 2. Very quiet output, loss of gain, or complete silence after building
...
## 3. A resistor value doesn't match the current PCB revision
