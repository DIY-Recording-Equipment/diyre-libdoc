...
- For 4:1 ratio the resistor should be a jumper (stock option)
- For 8:1 it should be 3.6k Ohms
- For 12:1 it should be 9.1k Ohms (stock option)
- For 20:1 it should be open (nothing mounted for the limit ratio resistor)
