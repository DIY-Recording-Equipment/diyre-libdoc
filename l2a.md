...
sorting_sheet_url:
schematic_url: https://cdn.shopify.com/s/files/1/0698/2265/files/L2A_Rev_E_Schematic.pdf?v=1749672239
---
...
{% alert 'This guide is for the L2A Rev E, launched August 2021. If you have an earlier version, head over to the [L2A Rev D Assembly Guide](https://www.diyrecordingequipment.com/pages/l2a-manual).', 'warning', 'Version Check' %}
