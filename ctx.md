...
{% stepBlock '/assets/ctx/colour-standoffs.jpg', 'md' %}
...
{% stepBlock '/assets/ctx/colour-header.jpg', 'md' %}
...
{% stepBlock '/assets/ctx/tape-sockets.jpg', 'md' %}
...
{% stepBlock '/assets/ctx/solder-sockets.jpg', 'md' %}
...
{% stepBlock '/assets/ctx/res-bend.jpg', 'md' %}
### Bend Resistors {.step}
...
{% stepBlock '/assets/ctx/res-place.jpg', 'md' %}
...
{% stepBlock '/assets/ctx/res-solder.jpg', 'md' %}
...
{% stepBlock '/assets/ctx/res-trim.jpg', 'md' %}
### Trim Resistors {.step}
...
{% stepBlock '/assets/ctx/caps-small.jpg', 'md' %}
...
{% stepBlock '/assets/ctx/caps-large.jpg', 'md' %}
...
{% stepBlock '/assets/ctx/trafo.jpg', 'md' %}
...
{% stepBlock '/assets/ctx/insert-doa.jpg', 'md' %}
### Insert DOA {.step}
...
{% stepBlock '/assets/ctx/finished.jpg', 'md' %}
### Build Completed!
