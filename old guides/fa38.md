...
Thank you for purchasing the [FA38 Colour](https://www.diyrecordingequipment.com/products/fa38-colour).
...
To identify and keep track of every part in the kit, download and print the [Component Sorting Sheet (PDF)](/assets/fa38/fa38-sorting-1.1.pdf).
...
{% checks 'capacitor', 'resistor', 'diode', 'transistor', 'solder' %}
Have a question or problem? [Drop us a line.](https://support.diy.re/)
