...
Thank you for purchasing a <a href="[kit url in store]">73P</a>.
...
Check the revision number in the upper-right of the main PCB. If yours says, v1.1, you are in the right place. If yours says v1.0, follow the <a href="https://manuals.diy.re/73p">73P v1.0 assembly guide</a>.
...
To easily find parts and keep track of which ones you have populated, use the <a href="https://maps.diy.re/73p2/" target="_blank">73P Interactive Build Map</a>.
...
<img class="schematic" src="%base_url%/assets/73p2/block01-power.png" />
...
T10<br>ZVP2106A transistor
            ...
            <img src="%base_url%/assets/parts/com-t026.png">
...
## Direct Input {.step}
<img class="schematic" src="%base_url%/assets/73p2/block02-di.png" />
...
## Balanced Input {.step}
<img class="schematic" src="%base_url%/assets/73p2/block03-input.png" />
...
C40<br>150p cap
        ...
        <img src="%base_url%/assets/parts/com-c087.png">
...
XC1<br>VTB9045 transformer
        ...
        <img src="%base_url%/assets/parts/com-x015.png">
...
## Gain {.step}
<img class="schematic" src="%base_url%/assets/73p2/block04-gain.png" />
...
## PRE 1 {.step}
<img class="schematic" src="%base_url%/assets/73p2/block05-pre1.png" />
...
C4<br>1500p cap
            ...
            <img src="%base_url%/assets/parts/com-c090.png">
Markings: WIMA 1500
...
C7<br>680p cap
            ...
            <img src="%base_url%/assets/parts/com-c088.png">
...
## PRE 2 {.step}
<img class="schematic" src="%base_url%/assets/73p2/block06-pre2.png" />
...
## OUTPUT {.step}
<img class="schematic" src="%base_url%/assets/73p2/block07-output.png" />
...
C19<br>330p cap
            ...
            <img src="%base_url%/assets/parts/com-c089.png">
Markings: WIMA 330/63

C21<br>4700p cap

            <img src="%base_url%/assets/parts/com-c062.png">
Markings: WIMA 4700 100

C22<br>220p cap

            <img src="%base_url%/assets/parts/com-c063.png">
...
---
 ...
 <video class="video" controls poster="%base_url%/assets/73p2/09-rew-setup-thumb.jpg">
        <source src="%base_url%/assets/73p2/09-rew-setup.mp4" type="video/mp4">
Your browser does not support the video tag.
    </video>
### Set Up Room EQ Wizard (REW) {.step}
    
1. Download and install REW from the <a href="https://www.roomeqwizard.com/">Room EQ Wizard website</a>.
...
---
 ...
 <video class="video" controls poster="%base_url%/assets/73p2/09-output-test-thumb.jpg">
        <source src="%base_url%/assets/73p2/09-output-test.mp4" type="video/mp4">
Your browser does not support the video tag.
    </video>
### Test Output {.step}
...
---
 ...
 <video class="video" controls poster="%base_url%/assets/73p2/09-output-cal-thumb.jpg">
        <source src="%base_url%/assets/73p2/09-output-cal.mp4" type="video/mp4">
Your browser does not support the video tag.
    </video>
...
---
    ...
    <video class="video" controls poster="%base_url%/assets/73p2/09-gain-cal-thumb.jpg">
        <source src="%base_url%/assets/73p2/09-gain-cal.mp4" type="video/mp4">
Your browser does not support the video tag.
    </video>
### Calibrate Gain {.step}
...
---
    ...
    <video class="video" controls poster="%base_url%/assets/73p2/09-features-test-thumb.jpg">
        <source src="%base_url%/assets/73p2/09-features-test.mp4" type="video/mp4">
Your browser does not support the video tag.
    </video>
### Test Features {.step}
