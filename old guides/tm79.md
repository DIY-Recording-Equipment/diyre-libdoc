...
Thank you for purchasing a <a href="https://www.diyrecordingequipment.com/products/tm79-colour">TM79</a>.
...
Before you begin, check the revision of your PCB. If yours has the version number "v1.1" on the bottom you are on the correct page. If it does not, please follow the <a href="http://www.diyrecordingequipment.com/pages/tm79-manual">TM79 v1.0 assembly guide</a>.
...
To identify and keep track of every part in the kit, download and print the <a href="%base_url%/assets/tm79/tm79-sorting-2.0.pdf" target="_blank">Component Sorting Sheet (PDF)</a>.
