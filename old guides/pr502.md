...
{% iconCard 'Component Sorting Sheet', 'To identify and keep track of every part in the kit, download and print the [Component Sorting Sheet](/assets/pr502/pr502-sorting-2.2.pdf)', '/assets/pdf-download.png' %}
...
{% checks 'capacitor', 'diode', 'resistor', 'solder', 'trim' %}
---
