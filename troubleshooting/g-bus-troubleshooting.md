...
- [Checking Your Assembly](/troubleshooting/checking-your-assembly/) — how to verify component position and orientation
...
4. If only one channel is affected, or the reading is inconsistent between tests, look for a cold solder joint in that channel's Balanced Input/Output section instead. See [Cleaning Up Solder Joints](/troubleshooting/cleaning-up-solder-joints/).
...
2. Check for a cold solder joint on CB2 and around the output transformers themselves. See [Cleaning Up Solder Joints](/troubleshooting/cleaning-up-solder-joints/).
